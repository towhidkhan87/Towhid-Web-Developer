...
import CV from '../assets/image/Towhid_CV.pdf'
        ...
        <div className='shadow-xl'>
            ...
            <div className="lg:w-1/2 slide-in-lg">
                ...
                <div className="flex gap-5 w-16 py-5 justify-center mx-auto lg:justify-start lg:mx-0">
                    <img src="/src/assets/image/figma.png" className="rounded-lg bg-gray-100 shadow-xl p-2"/>
                    <img src="/src/assets/image/js (1).png" className="rounded-lg bg-gray-100 shadow-xl p-2"/>
                    <img src="/src/assets/image/physics.png" className="rounded-lg bg-gray-100 shadow-xl p-2"/>
                </div>
            ...
            <div class="slide-up-lg">
                <img src="/src/assets/image/Towhid.png" className="w-96 rounded-lg shadow-2xl"/>
            </div>
        </div>
        </div>
    );
